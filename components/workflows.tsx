        ...
        <div className="pb-12 md:pb-20">
          ...
          <div className="mx-auto max-w-3xl pb-12 text-center md:pb-20">
            ...
            <h2 className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,var(--color-gray-200),var(--color-amber-200),var(--color-gray-50),var(--color-amber-300),var(--color-gray-200))] bg-[length:200%_auto] bg-clip-text pb-4 font-nacelle text-3xl font-semibold text-transparent md:text-4xl">
              Streamline Your Coal Supply Chain
            </h2>
            <p className="text-lg text-amber-200/65">
              Simplify coal sourcing, logistics, and quality control with our
              integrated marketplace. Connect with reliable suppliers and manage
                ...
                <div className="p-6">
                  <div className="mb-3">
                    <span className="btn-sm relative rounded-full bg-gray-800/40 px-2.5 py-0.5 text-xs font-normal hover:bg-gray-800/60">
                      <span className="bg-linear-to-r from-amber-500 to-amber-200 bg-clip-text text-transparent">
                        Verified Suppliers
                      </span>
                    </span>
                  </div>
                  <p className="text-amber-200/65">
                    Access a network of trusted coal suppliers, ensuring
                    high-quality materials and competitive pricing.
                  </p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950 after:absolute after:inset-0 after:bg-linear-to-br after:from-gray-900/50 after:via-gray-800/25 after:to-gray-900/50">
                ...
                <div className="p-6">
                  ...
                  <p className="text-amber-200/65">
                    Optimize transportation routes and manage deliveries with
            ...
            >
              <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950 after:absolute after:inset-0 after:bg-linear-to-br after:from-gray-900/50 after:via-gray-800/25 after:to-gray-900/50">
                ...
                <div className="p-6">
                  ...
                  <p className="text-amber-200/65">
                    Ensure consistent coal quality with our comprehensive
