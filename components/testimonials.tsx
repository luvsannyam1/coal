...
const testimonials = [
  ...
  },
  {
    ...
    company: "Forbes Inc.",
    content:
      "I've never been a fan of complicated website AI tools, which is why Coal Market is perfect for me. Its minimalist design and simple functionality make staying organized feel like second nature.",
    categories: [1, 4],
  },
  {
        ...
        <div>
          ...
          <div className="flex justify-center pb-12 max-md:hidden md:pb-16">
            <div className="relative inline-flex flex-wrap justify-center rounded-[1.25rem] bg-gray-800/40 p-1">
              {/* Button #1 */}
              <button
                className={`flex h-8 flex-1 items-center gap-2.5 whitespace-nowrap rounded-full px-3 text-sm font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-3 focus-visible:ring-amber-200 ${
                  category === 1
                    ? "relative bg-linear-to-b from-gray-900 via-gray-800/60 to-gray-900 before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(to_bottom,--theme(--color-amber-500/0),--theme(--color-amber-500/.5))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)]"
              ...
              >
                <svg
                  className={`fill-current ${
                    category === 1 ? "text-amber-500" : "text-gray-600"
                  }`}
              ...
              >
                <svg
                  className={`fill-current ${
                    category === 2 ? "text-amber-500" : "text-gray-600"
                  }`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height={16}
              ...
              >
                <svg
                  className={`fill-current ${
                    category === 3 ? "text-amber-500" : "text-gray-600"
                  }`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height={16}
              ...
              >
                <svg
                  className={`fill-current ${
                    category === 4 ? "text-amber-500" : "text-gray-600"
                  }`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height={16}
              ...
              >
                <svg
                  className={`fill-current ${
                    category === 5 ? "text-amber-500" : "text-gray-600"
                  }`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height={16}
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4">
        ...
        <p className="text-amber-200/65 before:content-['“'] after:content-['”']">
          {children}
        </p>
        <div className="flex items-center gap-3">
          ...
          <div className="text-sm font-medium text-gray-200">
            ...
            <a
              className="text-amber-200/65 transition-colors hover:text-amber-500"
              href="#0"
            >
              {testimonial.company}
            </a>
