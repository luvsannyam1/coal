...
export default function ModalVideo({
  ...
  return (
    <div className="relative">
      ...
      {/* Video thumbnail */}
      <button
        className="group relative flex items-center justify-center rounded-2xl focus:outline-hidden focus-visible:ring-3 focus-visible:ring-amber-200"
        onClick={() => {
          setModalOpen(true);
        }}
        ...
        data-aos-delay={200}
      >
        <figure className="relative overflow-hidden rounded-2xl before:absolute before:inset-0 before:-z-10 before:bg-linear-to-br before:from-gray-900 before:via-amber-500/20 before:to-gray-900">
          <Image
